...
```bash
git remote add encore encore://elb-fx-forex-signals-dh62
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/elb-fx-forex-signals-dh62/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/elb-fx-forex-signals-dh62/settings/integrations/github)
